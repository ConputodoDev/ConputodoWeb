...
import { 
  ...
  Printer, BatteryCharging, Cpu, Gamepad2, Zap, Send
} from 'lucide-react';
      ...
      <header className="bg-white sticky top-0 z-40 shadow-sm border-b border-gray-100">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6">
            ...
            <button onClick={() => setCurrentView('contact')} className="text-sm font-bold text-slate-600 hover:text-[#FF6600] transition-colors hidden md:block">Contacto</button>
        ...
        <div className="sm:hidden px-4 pb-3 space-y-3">
           ...
           {isMenuOpen && (
               <div className="flex flex-col gap-2 pt-2 border-t animate-in slide-in-from-top-2">
                   ...
                   <button onClick={() => setCurrentView('contact')} className="text-left font-medium py-2 hover:text-[#FF6600]">Contacto</button>
               </div>
           )}
        </div>
      </header>
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await addDoc(collection(db, "wholesale_requests"), {
        ...
        emailStatus: 'pending' // Esto servirá para que el backend sepa que debe enviar correo
      });
      setStatus('success');
      ...
      <div className="container mx-auto px-4 py-16 grid grid-cols-1 lg:grid-cols-2 gap-12">
        <div className="space-y-8">
            ...
            <div className="space-y-6">
                <div className="flex items-start gap-4"><div className="p-3 bg-orange-100 text-[#FF6600] rounded-lg"><MapPin size={24}/></div><div><h4 className="font-bold text-slate-800">Ubicación</h4><p className="text-slate-600">Av. Bolívar, Centro Comercial Global, Local 12.<br/>Maracay, Edo. Aragua.</p></div></div>
            ...
            <div className="w-full h-64 bg-gray-200 rounded-2xl overflow-hidden border border-gray-200 shadow-inner">
                <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15704.586616420504!2d-67.6003361!3d10.2497538!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8e803c9ea66dc035%3A0x3d9a806508507ccb!2scoNputodo!5e0!3m2!1ses-419!2sve!4v1749733697826!5m2!1ses-419!2sve" width="100%" height="100%" style={{border:0}} allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
            </div>
        </div>
