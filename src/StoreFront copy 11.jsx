...
export default function StoreFront() {
  ...
  const goHome = () => { setCurrentView('home'); setViewProduct(null); setSearchTerm(''); setSearchSuggestions([]); window.scrollTo({ top: 0, behavior: 'smooth' }); };
  ...
  const goToCatalog = (category = '') => { setSelectedCategory(category); setCurrentView('catalog'); setViewProduct(null); setSearchTerm(''); setSearchSuggestions([]); window.scrollTo({ top: 0, behavior: 'smooth' }); };
  ...
  // --- LÓGICA DE ANIMACIÓN BÚSQUEDA ---
  // Determina si el dropdown debe mostrarse (para la clase CSS)
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans text-slate-800 relative">
      ...
      {/* MODAL CARRITO (Siempre renderizado, controlado por CSS para animación) */}
      <CartModal 
        isOpen={isCartOpen}
        cart={cart} 
        setCart={setCart} 
      ...
      <header className="bg-white sticky top-0 z-40 shadow-sm border-b border-gray-100">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between gap-4">
          ...
          <div className="flex-1 max-w-xl relative hidden sm:block group" ref={searchRef}>
            ...
            {/* Live Search Dropdown - ANIMACIÓN SUAVIZADA */}
            {/* Renderizamos siempre el div pero jugamos con opacidad y visibilidad */}
      ...
      {currentView === 'home' && (
        <div className="animate-in fade-in duration-700">
          ...
          {/* HERO - ANIMACIÓN IMAGEN MEJORADA */}
          <div className="relative bg-neutral-900 text-white overflow-hidden">
            <div className="absolute inset-0">
                {marketingData.heroImage ? (
                    <>
                        {/* ANIMACIÓN DE IMAGEN: Opacidad 0 -> 100, Escala 100 -> 105 suavemente */}
                        <img 
                            src={marketingData.heroImage} 
                            className="w-full h-full object-cover opacity-60 animate-in fade-in zoom-in-105 duration-[2000ms]" 
                            style={{ animationFillMode: 'both' }} // Asegura que se quede en el estado final
                        />
        ...
        <footer className="bg-neutral-900 text-white pt-16 pb-8 border-t border-neutral-800 mt-auto">
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                    ...
                    <div>
                        <h4 className="font-bold text-lg mb-6 border-b border-neutral-800 pb-2 inline-block">Conputodo Principal</h4>
                        <ul className="space-y-4">
                            <li>
                                <a href="#" target="_blank" className="flex items-center gap-3 text-neutral-400 hover:text-pink-500 transition-colors">
                                    <Instagram size={20} /> <span>@conputodo</span>
                                </a>
                            </li>
                            <li>
                                <a href="#" target="_blank" className="flex items-center gap-3 text-neutral-400 hover:text-blue-500 transition-colors">
                                    <Facebook size={20} /> <span>Conputodo</span>
                                </a>
                            </li>
                            <li>
                                <a href="#" target="_blank" className="flex items-center gap-3 text-neutral-400 hover:text-green-500 transition-colors">
                                    <MessageCircle size={20} /> <span>WhatsApp Ventas</span>
                                </a>
                            </li>
                            <li>
                                <a href="#" target="_blank" className="flex items-center gap-3 text-neutral-400 hover:text-white transition-colors">
                    ...
                    <div>
                        <h4 className="font-bold text-lg mb-6 border-b border-neutral-800 pb-2 inline-block">Conputodo Gamer</h4>
                        <ul className="space-y-4">
                            <li>
                                <a href="#" target="_blank" className="flex items-center gap-3 text-neutral-400 hover:text-purple-500 transition-colors group">
                                    <div className="p-1 bg-neutral-800 rounded group-hover:bg-purple-900 transition-colors"><Instagram size={16} /></div>
                                    <span>@conputodogamer</span>
                                </a>
                            </li>
                            <li>
                                <a href="#" target="_blank" className="flex items-center gap-3 text-neutral-400 hover:text-blue-600 transition-colors group">
                                    <div className="p-1 bg-neutral-800 rounded group-hover:bg-blue-900 transition-colors"><Facebook size={16} /></div>
        ...
        <div className="container mx-auto px-4 py-16 max-w-4xl animate-in fade-in duration-500">
            ...
            <div className="bg-white p-8 md:p-12 rounded-2xl shadow-sm border border-gray-100 space-y-10">
                <div className="text-center border-b border-gray-100 pb-8">
                    ...
                    <p className="text-slate-500 mt-2">Transparencia y confianza para nuestros clientes.</p>
                </div>

                <div className="space-y-4">
                    <h3 className="text-xl font-bold text-slate-900 flex items-center gap-2">🛡️ Políticas de Garantía</h3>
                    <div className="prose text-slate-600 text-sm leading-relaxed space-y-2">
                ...
                <div className="space-y-4">
                    <h3 className="text-xl font-bold text-slate-900 flex items-center gap-2">🚚 Envíos y Entregas</h3>
                    <div className="prose text-slate-600 text-sm leading-relaxed space-y-2">
                ...
                <div className="space-y-4">
                    <h3 className="text-xl font-bold text-slate-900 flex items-center gap-2">🔒 Privacidad de Datos</h3>
                    <div className="prose text-slate-600 text-sm leading-relaxed space-y-2">
                ...
                <div className="space-y-4">
                    <h3 className="text-xl font-bold text-slate-900 flex items-center gap-2">💳 Pagos</h3>
                    <div className="prose text-slate-600 text-sm leading-relaxed space-y-2">
...
// --- MODAL CARRITO (CON ANIMACIÓN DE SLIDE IN/OUT) ---
function CartModal({ isOpen, cart, setCart, onClose, totalUSD, onRemove, exchangeRate }) {
  ...
  return (
    // BACKDROP: Opacidad animada y pointer-events para click-through cuando está cerrado
      ...
      >
        ...
        <div className="p-4 border-b flex justify-between items-center bg-slate-50">
            <h2 className="font-bold text-lg text-slate-800">
                {step === 'cart' ? 'Tu Carrito' : step === 'form' ? 'Finalizar Compra' : 'Pedido Creado'}
            </h2>
