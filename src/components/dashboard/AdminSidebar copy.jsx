    ...
    <aside className="w-64 bg-black text-neutral-400 hidden md:flex flex-col flex-shrink-0 border-r border-neutral-800 h-screen sticky top-0">
      ...
      <div className="p-4 border-t border-neutral-800">
        <div className="px-2 pb-2 mb-2 border-b border-neutral-800">
            <span className="block text-xs font-bold text-neutral-500 uppercase">Usuario</span>
            <span className="block text-sm text-white truncate">{user?.email}</span>
            <span className="block text-[10px] text-[#FF6600] uppercase font-bold mt-0.5">
