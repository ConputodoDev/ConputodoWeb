...
import { 
  getFirestore, collection, addDoc, getDocs, deleteDoc, updateDoc, doc, setDoc, onSnapshot, getDoc, writeBatch 
...
export default function FullDashboard() {
  ...
  const [isFeatured, setIsFeatured] = useState(false); // NUEVO: Estado Destacado
    ...
    <div className="flex h-screen bg-neutral-100 font-sans text-neutral-800 overflow-hidden">
      ...
      <main className="flex-1 flex flex-col min-w-0 h-full overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto p-8 scroll-smooth">
            ...
            {/* VISTA FORMULARIO (CON SWITCH DESTACADO) */}
               ...
               <div className="pb-12">
                   ...
                   <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
                       ...
                       <div className="space-y-6">
                            ...
                            {/* Organización (Categoría, Marca, Tags) - ACTUALIZADO CON DESTACAR */}
